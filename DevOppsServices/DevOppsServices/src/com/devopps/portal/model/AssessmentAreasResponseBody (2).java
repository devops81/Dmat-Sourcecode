...
public class AssessmentAreasResponseBody {
	...
	private List<AssessmentEntity> assessmentAreaList;
	private String statusMsg;
	
	/**
	 * @return the assessmentAreaList
	 */
	public List<AssessmentEntity> getAssessmentAreaList() {
		return assessmentAreaList;
	}
	/**
	 * @param assessmentAreaList the assessmentAreaList to set
	 */
	public void setAssessmentAreaList(List<AssessmentEntity> assessmentAreaList) {
