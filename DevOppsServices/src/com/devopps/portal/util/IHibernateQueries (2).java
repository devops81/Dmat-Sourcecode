...
public interface IHibernateQueries {
	...
	public static final String GET_USERAPP_MAPPING_DATA="select distinct a.name,b.application_name from user_profile a INNER JOIN application_master b on a.user_id=b.application_id where a.name=?";
