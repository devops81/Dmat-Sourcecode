...
public class ProfileServiceImpl implements IProfileService{
	...
	private String buildSuccessResponses() {
		String response = null;
		ResponseHeader responseHeader = new ResponseHeader();
		SaveProfileResponseBody responseBody = new SaveProfileResponseBody();
		responseHeader.setStatusCode(IStatusCodeConstants.STATUS_SUCCESS);
	...
	public String saveProfile(String  s) {
		...
		String response ;
		try {
			profileDao.saveProfile(s);
		} catch (HibernateException ex) {
		 	ExceptionHandler.handle(ex);
			return buildFailureReponses();
		} catch (Exception ex) {
			ExceptionHandler.handle(ex);
			return buildFailureReponses();
		}
		response = buildSuccessResponses();
		return response;
	}
	...
	@Override
	public SaveNotificationServiceResponse getApplications(String userId) {
		// TODO Auto-generated method stub
		return null;
	}
