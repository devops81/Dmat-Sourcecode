...
public class AssessmentServiceImpl implements IAssessmentService{
	...
	public AssessmentAreasServiceResponse getAssessmentAreas(Boolean isMappingRequired) {
		...
		List<AssessmentApplicationDetails>  assessmentAreaDetails = null;
		try {
			assessmentAreaDetails = assessmentAreasDao.getAssessmentAreas(isMappingRequired);
	...
	private AssessmentAreasServiceResponse buildAssessmentAreasResponse(List<AssessmentApplicationDetails>  assessmentAreaDetails, String statusDesc, String statusCode) {
		AssessmentAreasServiceResponse response = new AssessmentAreasServiceResponse();
