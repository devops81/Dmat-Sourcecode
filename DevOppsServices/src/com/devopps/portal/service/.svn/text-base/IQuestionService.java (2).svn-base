...
public interface IQuestionService {
	...
	QuestionServiceResponse saveQuestion(SaveQuestionRequestBody saveQuestionRequestBody);
	ViewQuestionnaireResponse getQuestionDetails (int questionnaireType); 
}
