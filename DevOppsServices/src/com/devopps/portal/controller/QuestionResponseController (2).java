...
public class QuestionResponseController extends AbstractController {
	...
	public @ResponseBody String viewQuestionScoreResponse(HttpServletRequest request,@PathVariable Integer version, @RequestBody ViewQuestionScoreRequestBody viewQuestionScoreRequestBody) {
		...
		System.out.println("Before sending request to serviceImpl--->"+System.currentTimeMillis());
		...
		System.out.println(":: Before Converted JSON :: "+System.currentTimeMillis());
		String jsonResponse= convertXMlToJson(stringXML);
		System.out.println(":: After Converted JSON  :: "+System.currentTimeMillis());
	   return jsonResponse;
