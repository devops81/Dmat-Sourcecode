...
public class AssessmentAreasController extends AbstractController {
	...
	/*
	 * URL :
	 *  http://localhost:8080/DevOppsServices/assessment/getAssessmentAreas/1.0 /0
	 * 
	 * Response :
	 * 
	 * {"response": {
	...
	@RequestMapping(value = "/getAssessmentAreas/{isMappingRequired}/{version}",method = RequestMethod.POST, produces = "application/xml")
	public @ResponseBody String getAssessmentAccountMapping(HttpServletRequest request,@PathVariable Boolean isMappingRequired,@PathVariable Integer version) {
		LOGGER.debug("[getAssessmentAreas] Service :: Start");
		String indentedJson = null;
		AssessmentAreasServiceResponse response = null;
		response =assessmentService.getAssessmentAreas(isMappingRequired);
