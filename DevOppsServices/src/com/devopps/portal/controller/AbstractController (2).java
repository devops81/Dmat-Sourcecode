...
private Jaxb2Marshaller jaxbMarshaller;
	...
	public String marshal(Object graph) {
		try {		
			...
			System.out.println("Inside Marshal--->Before--->"+System.currentTimeMillis());
			getJaxbMarshaller().marshal(graph, xmlFileResult);
			System.out.println("Inside Marshal--->After--->"+System.currentTimeMillis());
			System.out.println("After converting to xml---->"+System.currentTimeMillis());
	...
	public String convertStringToJson(String Response) {
		JSONObject jsonObject = new JSONObject();
		int indentFactor = 4;
		String indentedJson = null;
		try {
			...
			LOGGER.error( "AbstractController: convertStringToJson: Error :: " + jse );
			jse.printStackTrace();
		}
		return indentedJson;
